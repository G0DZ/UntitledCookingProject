...
RecipeParser::RecipeParser(QString content)
{
    //получаем страницу
    htmlPage = content;
    //парсим ее
...
Recipe RecipeParser::getRecipe() const
{
    return tempRecipe;
}

void RecipeParser::setRecipe(const Recipe &value)
{
    tempRecipe = value;
}

bool RecipeParser::parse()
{
...
QString RecipeParser::parsePublishDate()
{
    ...
    return tempRecipe.getPublishDate();
}
